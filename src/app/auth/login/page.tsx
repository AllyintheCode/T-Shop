    ...
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-10">
          <h1 className="text-3xl font-bold text-foreground mb-2">Xoş Gəldiniz</h1>
          <p className="text-gray-400 text-[0.95rem]">Hesabınıza daxil olaraq sifarişlərinizi davam etdirin.</p>
        </div>
        ...
        <form onSubmit={handleLogin}>
          ...
          <div className="flex justify-end mb-4">
            <Link href="#" className="text-sm text-primary no-underline hover:text-primary-dark transition-colors">Şifrəni unutmusunuz?</Link>
          </div>
        ...
        <div className="text-center mt-8 text-[0.95rem] text-gray-400">
          Hesabınız yoxdur? 
          <Link href="/auth/register" className="text-primary font-semibold ml-2 no-underline hover:text-primary-dark transition-colors">Qeydiyyatdan Keçin</Link>
        </div>
      </motion.div>
    </div>
  );
